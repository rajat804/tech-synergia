...
const AccountingSoftware = () => {
  ...
  const stats = [
    { number: "150+", label: "Accounting Apps", icon: <FiDollarSign />, color: "from-emerald-500 to-emerald-600", suffix: "Delivered" },
    { number: "98%", label: "Accuracy Rate", icon: <FiCheckCircle />, color: "from-blue-500 to-blue-600", suffix: "Guaranteed" },
    { number: "12+", label: "Years Experience", icon: <FiClock />, color: "from-purple-500 to-purple-600", suffix: "In Finance" },
    { number: "20+", label: "Countries", icon: <FiGlobe />, color: "from-pink-500 to-pink-600", suffix: "Worldwide" },
    { number: "50+", label: "Finance Experts", icon: <FiUsers />, color: "from-orange-500 to-orange-600", suffix: "Team" },
    { number: "500K+", label: "Transactions/Day", icon: <FiDatabase />, color: "from-red-500 to-red-600", suffix: "Processed" }
  ];
  ...
  const accountingModules = [
    ...
    },
    {
      ...
      icon: <FiBarChart2 />,
      features: ["Profit & Loss", "Balance Sheet", "Cash Flow", "Trial Balance"],
    ...
    },
    {
      ...
      description: "Process employee salaries and deductions",
      icon: <FiUsers />,
      features: ["Salary Processing", "Tax Deductions", "Payslips", "Statutory Compliance"],
      color: "from-teal-500 to-teal-600",
      iconColor: "text-teal-600"
    },
    {
      title: "Inventory Accounting",
      description: "Track inventory costs and valuation",
      icon: <FiPackage />,
      features: ["Cost Tracking", "Inventory Valuation", "COGS Calculation", "Stock Reports"],
  ...
  const features = [
    { title: "Automated Invoicing", icon: <FiFileText />, color: "from-emerald-500 to-emerald-600", desc: "Generate and send invoices automatically" },
    { title: "Expense Tracking", icon: <FiCreditCard />, color: "from-blue-500 to-blue-600", desc: "Monitor and categorize business expenses" },
    { title: "Real-time Reports", icon: <FiBarChart2 />, color: "from-purple-500 to-purple-600", desc: "Instant financial insights and dashboards" },
    { title: "Tax Compliance", icon: <FiShield />, color: "from-pink-500 to-pink-600", desc: "Stay compliant with tax regulations" },
    { title: "Multi-user Access", icon: <FiUsers />, color: "from-orange-500 to-orange-600", desc: "Role-based access for team members" },
    { title: "Data Security", icon: <FiShield />, color: "from-green-500 to-green-600", desc: "Bank-level encryption for your data" },
    { title: "Cloud Backup", icon: <FiCloud />, color: "from-teal-500 to-teal-600", desc: "Automatic cloud backup and recovery" },
    { title: "Mobile Access", icon: <FiCpu />, color: "from-indigo-500 to-indigo-600", desc: "Access your books from anywhere" }
  ];

  const benefits = [
    { title: "Save Time", icon: <FiClock />, color: "from-emerald-500 to-emerald-600", desc: "Automate repetitive accounting tasks" },
    { title: "Reduce Errors", icon: <FiCheckCircle />, color: "from-blue-500 to-blue-600", desc: "Minimize manual data entry mistakes" },
    { title: "Better Decisions", icon: <FiTrendingUp />, color: "from-purple-500 to-purple-600", desc: "Real-time financial insights" },
    { title: "Cash Flow Control", icon: <FiDollarSign />, color: "from-pink-500 to-pink-600", desc: "Monitor and improve cash flow" },
    { title: "Tax Ready", icon: <FiFileText />, color: "from-orange-500 to-orange-600", desc: "Always prepared for tax season" },
    { title: "Scalable", icon: <FiLayers />, color: "from-green-500 to-green-600", desc: "Grows with your business needs" }
  ];
  ...
  const integrations = [
    ...
    { name: "CRM", icon: "👥", color: "from-pink-500 to-pink-600", bg: "bg-pink-100", textColor: "text-pink-600" },
    { name: "Payroll", icon: "💰", color: "from-orange-500 to-orange-600", bg: "bg-orange-100", textColor: "text-orange-600" },
    { name: "Inventory", icon: "📦", color: "from-green-500 to-green-600", bg: "bg-green-100", textColor: "text-green-600" },
    { name: "POS Systems", icon: "🛍️", color: "from-teal-500 to-teal-600", bg: "bg-teal-100", textColor: "text-teal-600" },
    { name: "Tax Software", icon: "📊", color: "from-indigo-500 to-indigo-600", bg: "bg-indigo-100", textColor: "text-indigo-600" }
  ];

  const industries = [
    { name: "Retail", icon: "🛍️", color: "from-emerald-500 to-emerald-600", bg: "bg-emerald-100", textColor: "text-emerald-600" },
    ...
    { name: "Real Estate", icon: "🏠", color: "from-pink-500 to-pink-600", bg: "bg-pink-100", textColor: "text-pink-600" },
    { name: "Consulting", icon: "💼", color: "from-orange-500 to-orange-600", bg: "bg-orange-100", textColor: "text-orange-600" },
    { name: "Non-profit", icon: "🤝", color: "from-green-500 to-green-600", bg: "bg-green-100", textColor: "text-green-600" },
    { name: "Education", icon: "📚", color: "from-teal-500 to-teal-600", bg: "bg-teal-100", textColor: "text-teal-600" },
    { name: "Technology", icon: "💻", color: "from-indigo-500 to-indigo-600", bg: "bg-indigo-100", textColor: "text-indigo-600" }
  ];
  ...
  const filteredModules = activeTab === "all" 
    ? accountingModules 
    : activeTab === "core"
      ? accountingModules.filter(m => ["General Ledger", "Accounts Payable", "Accounts Receivable", "Bank Reconciliation"].includes(m.title))
      : activeTab === "operations"
        ? accountingModules.filter(m => ["Payroll Management", "Inventory Accounting", "Fixed Assets", "Tax Management"].includes(m.title))
        : accountingModules.filter(m => ["Financial Reporting", "Budgeting & Forecasting", "Audit Trail", "Multi-currency Support"].includes(m.title));
    ...
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center text-white">
          ...
          >
            Streamline your finances with powerful, intuitive accounting solutions.
            <br className="hidden sm:block" />
            150+ accounting applications delivered with 98% accuracy.
          </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Comprehensive modules for complete financial management
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Benefits that make accounting easier and more efficient
            </p>
          </motion.div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Tailored accounting solutions for every industry
            </p>
          </motion.div>
